...
<div class="banner-top" style="background-image: url('<?= $setting['nhapho_banner']['url'] ?>');">
	<div class="baobanner pd50">
		<div class="container">
			<div class="content-banner">

				<h4 class="nhapho-bn-title">
					<img src="<?= get_template_directory_uri() ?>/libs/images/line.png">
					<span class=""><?= $setting['nhapho_title_1'] ?></span> 
					<img src="<?= get_template_directory_uri() ?>/libs/images/line.png">
				</h4>
				<p><?= $setting['nhapho_desc'] ?></p>
...
<div class="landing-project pd50">
	<div class="container">
		<h2 class="theme-main-np-title"><span>Các dự án <strong>đã hoàn thiện</strong></span></h2>
		<div class="row pd30">
...
<div class="quytrinh-np pd50">
	<div class="container">
		<div class="mota-quytrinh">
			<h4 class="title-bottom-np"><?= $setting['bt_quytrinh_title_1'] ?>  <span><?= $setting['bt_quytrinh_title_2'] ?></span></h4>
			<p class="hoa-van-np"><span></span></p>
		...
		<div class="danhsach-quytrinh pd30">
			...
			<div class="btn-tuvan">
				<a href="#cantuvan" class="btntuvan-np">Cần tư vấn</a>
			</div>
...
<div class="banggia pd50" id="banggia">
	<div class="container">
		<div class="mota-quytrinh">
			<h4 class="title-bottom-np"><?= $setting['bt_banggia_title_1'] ?> <span><?= $setting['bt_banggia_title_2'] ?></span></h4>
			<p class="hoa-van-np"><span></span></p>
		</div>

		<div class="danhsach-banggia pd30">
			<div class="row">
				...
				<?php if(!empty($listBG)): ?>
					<?php foreach($listBG as $key=>$val): ?>
						<div class="col-lg-4 <?= ($key==0||$key==2) ? 'mgt80' : '' ?> ">
							<div class="list-banggia-np">
								<div class=""><h3 class="<?= ($key==1) ? 'bg-do' : 'bg-den' ?>" >Gói <span><?= $val['list_bg_title'] ?></span></h3></div>
								<?= $val['list_bg_check'] ?>
								<div class="cantuvan">
									<a href="#cantuvan" class="btntuvan-np <?= ($key==1) ? 'btndac-np' : '' ?>">Cần tư vấn</a>
								</div>
							</div>
						</div>
					<?php endforeach; ?>
...
<div class="trietly">
	<div class="container">
		<div class="bao-shadow-trietly" id="cantuvan">
			<div class=" pd50">
				<div class="mota-quytrinh">
					<h4 class="title-bottom-np"><?= $setting['bt_trietly_title_1'] ?> <span><?= $setting['bt_trietly_title_2'] ?></span></h4>
					<p class="hoa-van-np"><span></span></p>
				</div>
				<div class="row">
					<div class="col-lg-12">
							...
							<div class="form-tuvan-tl">
								...
								<form method="post" action="#">
									<form action="" method="POST" role="form">
										...
										<button type="submit" class="btn btntuvan-tl">Cần tư vấn</button>
									</form>
								</form>
							</div>
